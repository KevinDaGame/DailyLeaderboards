...
public enum Message {
    ...
    STOP_EVENT_BROADCAST, STOP_EVENT_MESSAGE, TOO_FEW_ARGUMENTS_ERROR, TOO_MANY_ARGUMENTS_ERROR, LEADERBOARD_TIME_NO_EVENT, LEADERBOARD_TIME, LEADERBOARD_TIME_ENDED;
